...
async function main() {
    ...
    console.log('📤 Posted ephemeral message (will be deleted after processing)\n');

    // ========================================================================
    // Example 2: RETAIN_DURATION - Audit Trail (30 days)
    // ========================================================================
    console.log('📋 Example 2: RETAIN_DURATION - Audit Trail Queue\n');
    console.log('   Use case: Compliance, debugging, temporary audit requirements');
    console.log('   Behavior: Messages retained for 30 days after completion');
    console.log('   Storage: Moderate - automatic cleanup after retention period\n');
    ...
    console.log('📤 Posted order message (retained for 30 days after completion)\n');
    ...
    console.log('   Use case: Financial transactions, legal compliance, event sourcing');
    ...
    try {
        ...
        console.log('✅ Queue "financial-transactions" created (permanent retention)\n');
    } catch (err: any) {
        if (err?.message && /already exists/i.test(err.message)) {
    ...
    console.log('financial-transactions     | RETAIN_FOREVER    | ∞ (permanent)\n');
    ...
    console.log('   ✓ Common durations: 7 days (debug), 30 days (audit), 90 days (compliance)');
    ...
    console.log('   • Consider data privacy laws (GDPR, CCPA) when retaining data');
    console.log('   • Retained messages can be queried for analysis and debugging\n');
