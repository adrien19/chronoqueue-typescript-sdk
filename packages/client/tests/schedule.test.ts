...
const createMockClient = () => {
    ...
    return {
        createSchedule: jest.fn((req, cb) => { if (handlers.createSchedule) handlers.createSchedule(req, cb); else cb(null, { success: true }); }),
        getSchedule: jest.fn((req, cb) => { if (handlers.getSchedule) handlers.getSchedule(req, cb); else cb(null, { schedule: null }); }),
        listSchedules: jest.fn((req, cb) => { if (handlers.listSchedules) handlers.listSchedules(req, cb); else cb(null, { schedules: [] }); }),
        deleteSchedule: jest.fn((req, cb) => { if (handlers.deleteSchedule) handlers.deleteSchedule(req, cb); else cb(null, { success: true }); }),
        pauseSchedule: jest.fn((req, cb) => { if (handlers.pauseSchedule) handlers.pauseSchedule(req, cb); else cb(null, { success: true }); }),
        resumeSchedule: jest.fn((req, cb) => { if (handlers.resumeSchedule) handlers.resumeSchedule(req, cb); else cb(null, { success: true }); }),
        getScheduleHistory: jest.fn((req, cb) => { if (handlers.getScheduleHistory) handlers.getScheduleHistory(req, cb); else cb(null, { scheduleHistory: null }); }),
...
describe("ScheduleClient", () => {
    ...
    describe("createSchedule", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(scheduleClient.createSchedule(schedule as any)).rejects.toThrow("Server error");
        });

        it("should throw error when schedule is not provided", async () => {
            await expect(scheduleClient.createSchedule(null as any)).rejects.toThrow();
        });
    });
    ...
    describe("getSchedule", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(scheduleClient.getSchedule("test-schedule-1")).rejects.toThrow("Not found");
        });
    ...
    describe("listSchedules", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(scheduleClient.listSchedules()).rejects.toThrow("Server unavailable");
        });
    });
    ...
    describe("deleteSchedule", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(scheduleClient.deleteSchedule("test-schedule-1")).rejects.toThrow("Permission denied");
        });
    ...
    describe("pauseSchedule", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(scheduleClient.pauseSchedule("test-schedule-1")).rejects.toThrow("Schedule not found");
        });
    ...
    describe("resumeSchedule", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(scheduleClient.resumeSchedule("test-schedule-1")).rejects.toThrow("Schedule not found");
        });
    ...
    describe("getScheduleHistory", () => {
        ...
        it("should use custom limit when provided", async () => {
            mockClient.setHandler('getScheduleHistory', (_req: any, cb: any) => {
                cb(null, { scheduleHistory: { scheduleId: "test-schedule-1", messages: [] } });
            });
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(scheduleClient.getScheduleHistory("test-schedule-1")).rejects.toThrow("Schedule not found");
        });
