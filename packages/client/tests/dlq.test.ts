...
const createMockClient = () => {
    ...
    return {
        getDlqMessages: jest.fn((req, cb) => { if (handlers.getDlqMessages) handlers.getDlqMessages(req, cb); else cb(null, { messages: [] }); }),
        requeueFromDlq: jest.fn((req, cb) => { if (handlers.requeueFromDlq) handlers.requeueFromDlq(req, cb); else cb(null, { success: true }); }),
        deleteFromDlq: jest.fn((req, cb) => { if (handlers.deleteFromDlq) handlers.deleteFromDlq(req, cb); else cb(null, { success: true }); }),
        purgeDlq: jest.fn((req, cb) => { if (handlers.purgeDlq) handlers.purgeDlq(req, cb); else cb(null, { success: true }); }),
        getDlqStats: jest.fn((req, cb) => { if (handlers.getDlqStats) handlers.getDlqStats(req, cb); else cb(null, { name: "", messageCount: "0", createdAt: "", updatedAt: "" }); }),
...
describe("DLQClient", () => {
    ...
    describe("getDLQMessages", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(dlqClient.getDLQMessages("test-queue-dlq")).rejects.toThrow("DLQ not found");
        });
    ...
    describe("requeueFromDLQ", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(dlqClient.requeueFromDLQ("test-queue-dlq", "msg-1")).rejects.toThrow("Message not found");
        });
        ...
        it("should throw error when messageId is not provided", async () => {
            await expect(dlqClient.requeueFromDLQ("test-queue-dlq", "")).rejects.toThrow();
        });
    });
    ...
    describe("deleteFromDLQ", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(dlqClient.deleteFromDLQ("test-queue-dlq", "msg-1")).rejects.toThrow("Message not found");
        });
        ...
        it("should throw error when messageId is not provided", async () => {
            await expect(dlqClient.deleteFromDLQ("test-queue-dlq", "")).rejects.toThrow();
        });
    });
    ...
    describe("purgeDLQ", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(dlqClient.purgeDLQ("test-queue-dlq")).rejects.toThrow("DLQ not found");
        });
    ...
    describe("getDLQStats", () => {
        ...
        it("should reject when server returns error", async () => {
            ...
            await expect(dlqClient.getDLQStats("test-queue-dlq")).rejects.toThrow("DLQ not found");
        });
        ...
        it("should reject when response is empty", async () => {
            ...
            await expect(dlqClient.getDLQStats("test-queue-dlq")).rejects.toThrow("Empty response from server");
        });
